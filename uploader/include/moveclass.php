...
<head>
    ...
    <title>Kenaikan Kelas | SISPPI</title>
...
<!-- / Navbar -->
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <hr>
            <form action="func/naik.php" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-8">
                        ...
                        <div class="card-datatable table-responsive">
                            ...
                            <tbody>
                                <?php
                                $i=1;
                                $santri = query("SELECT santri.*,kelas_santri.*,kelas.* FROM kelas_santri INNER JOIN santri ON kelas_santri.NIS = santri.NIS INNER JOIN kelas ON kelas_santri.id_kelas = kelas.id_kelas WHERE kelas_santri.id_kelas = '$idkelas'");
                                foreach ($santri as $san) :?>
                                <tr>
                                    <td><input type="checkbox" class="form-check-input" name="chkbox[]" value="<?=$san['id_kelas_santri'];?>"></td>
                                    <td><?=$i;?></td>
                                    <td><?=$san['NIS'];?></td>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4">
                        ...
                        <div class="card-header">
                            <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                                    <li class="nav-item">
                                    <button type="button" class="nav-link active"><i class="tf-icons bx bx-home"></i> Pilih Kelas</button>
                                    </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                <label class="form-label" for="kelaspil">Pilih Kelas <span class="text-danger">*</span></label>
                                <div class="input-group input-group-merge">
                                    <span id="kelaspil" class="input-group-text"><i class="bx bx-home"></i></span>
                                    <select name="kelaspil" id="kelaspil" class="form-control select2" required>
                                        <option value="">--Pilih Kelas--</option>
                                        <?php
                                            $kelaspil = query("SELECT * FROM kelas");
                                            foreach ($kelaspil as $klsp) :?>
                                            <option value="<?=$klsp['id_kelas'];?>"><?=ucwords($klsp['kelas']).' - '.$klsp['tingkat']?></option>
                                        <?php endforeach?>
                                    </select>
                                </div>
                                </div>
                                <div class="col-md-6">
                                <label class="form-label" for="kelaspil">Semester <span class="text-danger">*</span></label>
                                <div class="input-group input-group-merge">
                                    <span id="semester" class="input-group-text"><i class="bx bx-home"></i></span>
                                    <input type="number" class="form-control" name="semester" id="semester" required>
                                </div>
                                </div>
                                <div class="col-md-12" style="margin-top: 30px;">
                                    <button type="submit" class="btn btn-danger me-2">Proses Pindah/Naik Kelas <i class="bx bx-search-alt"></i></button>
                                </div>
                            </div>
                        </div>
                        </div>

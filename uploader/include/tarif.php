...
if (isset($_POST['cari'])) {
  ...
  $santri = query("SELECT SUM(bulan_pay.bulan_pay) AS 'totaltarif',bulan_pay.*,santri.*,kelas_santri.* FROM bulan_pay INNER JOIN santri ON bulan_pay.id_santri = santri.id_santri INNER JOIN kelas_santri ON kelas_santri.NIS = santri.NIS WHERE kelas_santri.id_kelas = '$kelas' AND bulan_pay.payment_id = '$payment_id' GROUP BY bulan_pay.id_santri;");
  $totsan = query("SELECT COUNT(DISTINCT(bulan_pay.id_santri)) AS 'jumtotsan',bulan_pay.*,santri.*,kelas_santri.* FROM bulan_pay INNER JOIN santri ON bulan_pay.id_santri = santri.id_santri INNER JOIN kelas_santri ON kelas_santri.NIS = santri.NIS WHERE kelas_santri.id_kelas = '$kelas' AND bulan_pay.payment_id = '$payment_id';")[0];
}
// }else {
              ...
              <div class="nav-align-top mb-4">
                ...
                <div class="tab-content">
                  <div class="tab-pane fade show active" id="navs-pills-justified-home" role="tabpanel">
                    ...
                    <a href="tarifclass.php?idpay=<?=$payment_id;?>" class="text-white"><button type="button" class="ml-3 btn btn-warning"> Berdasarkan Kelas <i class="bx bx-plus"></i> </button></a>
                    <a href="tarifsantri.php?idpay=<?=$payment_id;?>" class="text-white"><button type="button" class="ml-3 btn btn-success">Berdasarkan Santri <i class="bx bx-plus"></i></button></a>
                            ...
                            <table id="mantarifsantri" class="table table-responsive table-bordered">
                                ...
                                <tr>
                                    ...
                                    <div class="d-inline-block">
                                            ...
                                            <a href="ubahtarifsantri.php?idsan=<?=$san['id_santri'];?>&payment_id=<?=$san['payment_id'];?>" class="dropdown-item">Ubah</a>
                                                <div class="dropdown-divider"></div>
                                                <a href="func/hapustarifsantri.php?idsan=<?=$san['id_santri'];?>&payment_id=<?=$san['payment_id'];?>" onclick="return confirm('Apakah Anda Yakin Menghapus Tarif Santri Ini?')" class="dropdown-item text-danger delete-record">Hapus</a>
                                            </div>
                                            </div>
                                    </td>
                                </tr>

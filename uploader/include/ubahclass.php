...
$tgl = date('Y-m');
$idkelas = $_GET['id'];
$kelas = query("SELECT * FROM kelas WHERE id_kelas = '$idkelas'")[0];
          ...
          <div class="col-lg-12 col-md-12 col-12 mb-4">
            <div class="card">
              <div class="card-header">
                <h5 class="p">Ubah Kelas Santri</h5>
                <hr>
              </div>
              <div class="card-body">
                <form action="func/ubahclass.php" id="formAccountSettings" method="POST" enctype="multipart/form-data">
                        <input class="form-control" type="hidden" name="id" value="<?=$kelas['id_kelas'];?>">
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                <label class="form-label" for="kelas">Nama Kelas <?=$kelas['kelas'];?><span class="text-danger">*</span></label>
                                ...
                                <div class="input-group input-group-merge">
                                    <input class="form-control" type="number" id="tingkat" name="tingkat" placeholder="" value="<?=ucwords($kelas['tingkat']);?>"/>
                                </div>
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label class="form-label" for="wali">Wali Kelas</label>
                                    <select name="wali" id="wali" class="form-control select2">
                                    <?php
                                    $idwal = $kelas['id_wali'];
                                    $wali = query("SELECT * FROM users");
                                    foreach ($wali as $wli) :?>
                                    <option value="<?=$wli['id_user']?>" <?php if ($wli['id_user'] == $idwal) {
                                        echo "selected";
                                    } ?>><?=ucwords($wli['fullname']);?></option>
                                    <?php endforeach;?>
                                    </select>
                                </div>
                                <span><small><span class="text-danger">*</span>) Hati-Hati Dalam Mengubah Kelas Santri.</small></span>
                            </div>
                            <div class="mt-2">

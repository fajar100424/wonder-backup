...
$countmapel = query("SELECT COUNT(id_mapel) AS 'jummapel' FROM mapel");
    ...
    <div class="content-wrapper">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-12 mb-4">
                ...
                <h5 class="p">Manajemen Mata Pelajaran</h5>
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addNewMapel"> Tambah Mapel + </button>
                </div>
                <div class="card-body">
                <div class="col-xl-12">
                <div class="nav-align-top mb-4">
                    ...
                    <li class="nav-item">
                        <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-justified-home" aria-controls="navs-pills-justified-home" aria-selected="true"><i class="tf-icons bx bx-home"></i> Daftar Mata Pelajaran<span class="badge rounded-pill badge-center h-px-20 w-px-20 bg-danger"><?=$countmapel[0]['jummapel'];?></span></button>
                    </li>
                    </ul>
                    ...
                    <table id="manmapel" class="table table-responsive table-bordered">
                        ...
                        <tr>
                            <td><?=$i;?></td>
                            <td><span class="badge bg-label-success" style="font-size: large;"><a href="materi.php?idmapel=<?=$mpl['id_mapel'];?>"><?=ucwords($mpl['kode_mapel']);?></a></span></td>
                            <td><?=ucwords($mpl['mapel']);?></td>
                            <td>
                                <?php
                                $idpengajar = $mpl['id_pengajar'];
                                $pengajar = query("SELECT fullname FROM users WHERE id_user = '$idpengajar'")[0];
                                ?>
                                <?=ucwords($pengajar['fullname']);?>
                            </td>
                            <td>
                            <div class="d-inline-block">
                                    ...
                                    <a href="ubahmapel.php?id=<?=$mpl['id_mapel'];?>" class="dropdown-item">Ubah</a>
                                        <div class="dropdown-divider"></div>
                                        <a href="func/hapusmapel.php?id=<?=$mpl['id_mapel'];?>" onclick="return confirm('Apakah Anda Yakin Menghapus Mapel Ini?')" class="dropdown-item text-danger delete-record">Hapus</a>
                                    </div>
                                    </div>
                            </td>
                        </tr>
...
<!-- Add New Mapel -->
<div class="modal fade" id="addNewMapel" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body">
        ...
        <div class="text-center mb-4">
          ...
          <p>Tambah Mata Pelajaran Baru</p>
        </div>
        <form class="row g-3" action="func/addmapel.php" method="POST">
          <div class="col-12">
            <label class="form-label w-100" for="kode_mapel">Kode Mapel</label>
            <div class="input-group input-group-merge">
              <input id="kode_mapel" name="kode_mapel" class="form-control credit-card-mask" type="text" placeholder="KD123"/>
              <span class="input-group-text cursor-pointer p-1" id="modalAddCard2"><span class="card-type"></span></span>
            </div>
          </div>
          <div class="col-12 col-md-12">
            <label class="form-label" for="mapel">Nama Mapel</label>
            <input type="text" id="mapel" name="mapel" class="form-control" placeholder="Matematika" />
          </div>
          <div class="col-12 col-md-12">
            <label class="form-label" for="pengajar">Pengajar</label>
            <select name="pengajar" id="pengajar" class="form-control select2">

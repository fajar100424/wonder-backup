...
<head>
    ...
    <title>Kelompok Ngaji | SISPPI</title>
        ...
        <div class="navbar-nav align-items-center">
          <div class="nav-item navbar-search-wrapper mb-0">
            <a class="nav-item nav-link px-0">
              ...
              <span>
                <b>Pembagian Kelompok Ngaji Santri</b> 
              </span>
...
<!-- / Navbar -->
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                  <li class="nav-item">
                    <button type="button" class="nav-link active"><i class="tf-icons bx bx-home"></i> Pembagian Kelompok Ngaji Santri</button>
                  </li>
              </ul>
            </div>
            <div class="card-body">
            ...
            <div class="d-flex flex-column ps-1">
                ...
                <span>Hanya menampilkan santri yang belum ada kelompok mengaji pada kelas yang dipilih. Jika ada santri yang sudah dimasukkan kedalam kelompok ngaji tertentu pada kelas yang dipilih, maka untuk mengubah kelompok santri tersebut silakan cek pada kelompok ngaji nya masing-masing!</span>
            </div>
            </div>
            <hr>
            <form action="func/group.php" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-8">
                        ...
                        <div class="card-datatable table-responsive">
                            ...
                            <tbody>
                                <?php
                                $i=1;
                                $santri = query("SELECT santri.*,kelas_santri.*,kelas.* FROM kelas_santri INNER JOIN santri ON kelas_santri.NIS = santri.NIS INNER JOIN kelas ON kelas_santri.id_kelas = kelas.id_kelas WHERE kelas_santri.id_kelas = '$idkelas' AND NOT EXISTS (SELECT kelompok_santri.* FROM kelompok_santri WHERE kelompok_santri.id_santri = santri.id_santri)");
                                foreach ($santri as $san) :?>
                                <tr>
                                    <td><input type="checkbox" class="form-check-input" name="chkbox[]" value="<?=$san['id_santri'];?>"></td>
                                    <td><?=$i;?></td>
                                    <td><?=$san['NIS'];?></td>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4">
                        ...
                        <div class="card-header">
                            <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                                    <li class="nav-item">
                                    <button type="button" class="nav-link active"><i class="tf-icons bx bx-home"></i> Pilih Kelompok Ngaji</button>
                                    </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                <label class="form-label" for="grouppil">Pilih Kelompok <span class="text-danger">*</span></label>
                                <div class="input-group input-group-merge">
                                    <span id="grouppil" class="input-group-text"><i class="bx bx-home"></i></span>
                                    <select name="grouppil" id="grouppil" class="form-control select2" required>
                                        <option value="">--Pilih Kelompok--</option>
                                        <?php
                                            $grouppil = query("SELECT * FROM kelompok");
                                            foreach ($grouppil as $grp) :?>
                                            <option value="<?=$grp['id_kelompok'];?>"><?=ucwords($grp['kelompok'])?></option>
                                        <?php endforeach?>
                                    </select>
                                </div>
                                </div>
                                <div class="col-md-12" style="margin-top: 30px;">
                                    <button type="submit" class="btn btn-danger me-2">Proses Pembagian Kelompok <i class="bx bx-refresh"></i></button>
                                </div>
                            </div>
                        </div>
                        </div>

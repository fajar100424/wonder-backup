...
$tgl = date('Y-m');
$idkelompok = $_GET['id'];
$kelompok = query("SELECT * FROM kelompok WHERE id_kelompok = '$idkelompok'")[0];
          ...
          <div class="col-lg-12 col-md-12 col-12 mb-4">
            <div class="card">
              <div class="card-header">
                <h5 class="p">Ubah Kelompok Ngaji Santri</h5>
                <hr>
              </div>
              <div class="card-body">
                <form action="func/ubahkelompok.php" id="formAccountSettings" method="POST" enctype="multipart/form-data">
                        <input class="form-control" type="hidden" name="id" value="<?=$kelompok['id_kelompok'];?>">
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                <label class="form-label" for="kelas">Nama Kelompok <?=$kelompok['kelompok'];?><span class="text-danger">*</span></label>
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control" id="kelompok" name="kelompok" value="<?=$kelompok['kelompok'];?>"/>
                                </div>
                                </div>
                                <div class="mb-3 col-md-6">
                                    ...
                                    <?php
                                    $idpj = $kelompok['pj'];
                                    $penanggungjawab = query("SELECT * FROM users");
                                    foreach ($penanggungjawab as $pj) :?>
                                    <option value="<?=$pj['id_user']?>" <?php if ($pj['id_user'] == $idpj) {
                                        echo "selected";
                                    } ?>><?=ucwords($pj['fullname']);?></option>
                                    <?php endforeach;?>
                                    </select>
                                </div>
                                <span><small><span class="text-danger">*</span>) Hati-Hati Dalam Mengubah Kelompok Ngaji Santri.</small></span>
                            </div>
                            <div class="mt-2">

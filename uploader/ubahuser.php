...
<head>
    ...
    <title>Ubah Pengguna | SISPPI</title>
            ...
            <div class="col-lg-12 col-md-12 col-12 mb-4">
                ...
                <div class="card-body">
                    <form action="func/ubahuser.php" id="formAccountSettings" method="POST" enctype="multipart/form-data">
                            ...
                            <input class="form-control" type="hidden" name="gambarLama" value="<?= $user['gambar']; ?>">
                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                <img src="assets/img/avatars/<?=$user['gambar'];?>" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
                            ...
                            <br>
                                ...
                                <div class="row">
                                    ...
                                    <input class="form-control" type="email" id="email" name="email" placeholder="contoh@gmail.com" value="<?=$user['email'];?>" disabled/>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                    <label for="fullname" class="form-label">Nama Lengkap <span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" id="fullname" name="fullname" placeholder="Nama Lengkap" value="<?=$user['fullname'];?>" autofocus/>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                    <label for="notelp" class="form-label">No. Telepon (WA) <span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" id="notelp" name="notelp" placeholder="Nomor Telepon" value="<?= $user['notelp'];?>" autofocus/>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                    <label for="alamat" class="form-label">Alamat <span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" id="alamat" name="alamat" placeholder="Alamat" value="<?=$user['alamat'];?>" autofocus/>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                    <label for="unit" class="form-label">Unit <span class="text-danger">*</span></label>
                                    <select name="unit" id="unit" class="select2 form-select" required>
                                        <option value="">-- Pilih Unit --</option>
                                        <option value="1" <?php if ($user["id_unit"] === '1') {echo "selected";} else {echo " ";}?>>Admin</option>
                                        <option value="2" <?php if ($user["id_unit"] === '2') {echo "selected";} else {echo " ";}?>>Guru</option>
                                    </select>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                    ...
                                    <select name="status" id="status" class="select2 form-select" required>
                                        ...
                                        <option value="aktif" <?php if ($user["status"] === 'aktif') {echo "selected";} else {echo " ";}?>>Aktif</option>
                                        <option value="nonaktif" <?php if ($user["status"] === 'nonaktif') {echo "selected";} else {echo " ";}?>>Non-Aktif</option>
                                    </select>
                                    </div>

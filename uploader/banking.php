...
$idsan = $_GET['idsan'];
$nis = $_GET['nis'];
$santri = query("SELECT cashbank.* , santri.*,santri.status AS 'stats_santri', kelas_santri.*, kelas.*,thn_ajaran.* FROM cashbank INNER JOIN santri ON cashbank.id_santri = santri.id_santri INNER JOIN kelas_santri ON kelas_santri.NIS = santri.NIS INNER JOIN kelas ON kelas.id_kelas = kelas_santri.id_kelas INNER JOIN thn_ajaran ON thn_ajaran.id_thn = kelas_santri.id_tahun WHERE santri.id_santri = '$idsan';")[0];
$id_cashbank = $santri['id_cashbank'];
$totsan = query("SELECT COUNT(cashbank.id_cashbank) AS 'totsan' FROM cashbank INNER JOIN santri ON cashbank.id_santri = santri.id_santri INNER JOIN kelas_santri ON kelas_santri.NIS = santri.NIS INNER JOIN kelas ON kelas.id_kelas = kelas_santri.id_kelas WHERE santri.id_santri = '$idsan'")[0];
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                  <li class="nav-item">
                    <button type="button" class="nav-link active"><i class="tf-icons bx bx-trophy"></i> Profile Tabungan Bank Santri</button>
                    </li>
                </ul>
                <div class="row">
                    ...
                    <div class="mb-3 card">
                      ...
                      <div class="card-datatable table-responsive">
                        ...
                        <tbody>
                            <?php
                            $i=0;
                            $transbank = query("SELECT transaksi_bank.created_at AS 'tgl', transaksi_bank.*, cashbank.*, santri.* FROM transaksi_bank INNER JOIN cashbank ON transaksi_bank.id_cashbank = cashbank.id_cashbank INNER JOIN santri ON cashbank.id_santri = santri.id_santri WHERE cashbank.id_santri = $idsan;");
                            foreach ($transbank as $trans) :?>
                            <tr>
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6">
                    ...
                    <div class="card-header">
                      ...
                      <div class="col-md-6">
                        ...
                        <?php
                        $totsetor = query("SELECT SUM(nominal) AS 'totsetor' FROM transaksi_bank WHERE id_cashbank = '$id_cashbank' AND jenis = 'setoran'")[0];
                        ?>
                      ...
                      <div class="col-md-6">
                        ...
                        <?php
                        $tottarik = query("SELECT SUM(nominal) AS 'tottarik' FROM transaksi_bank WHERE id_cashbank = '$id_cashbank' AND jenis = 'penarikan'")[0];
                        ?>
                        ...
                        <div class="tab-content">
                            ...
                            <hr>
                                ...
                                <tbody>
                                    <?php
                                    $i=1;
                                    $transetor = query("SELECT cashbank.*, transaksi_bank.created_at AS 'tgl',transaksi_bank.*, santri.* FROM transaksi_bank INNER JOIN cashbank ON transaksi_bank.id_cashbank = cashbank.id_cashbank INNER JOIN santri ON cashbank.id_santri = santri.id_santri WHERE cashbank.id_cashbank = '$id_cashbank' AND transaksi_bank.jenis = 'setoran'");
                                    ...
                                    <tr>
                                      ...
                                      <div class="d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                          <a href="func/hapustransbank.php?id_cashbank=<?=$trs['id_cashbank'];?>&idsan=<?=$idsan;?>&nis=<?=$nis;?>&id_trans=<?=$trs['id_trans_bank'];?>" onclick="return confirm('Apakah Anda Yakin Menghapus Transaksi Ini?')" class="dropdown-item text-danger delete-record">Hapus</a>
                                        </div>
                                      </div>
                                      </td>
                                    </tr>
                            ...
                            <hr>
                                ...
                                <tbody>
                                    <?php
                                    $i=1;
                                    $transtarik = query("SELECT cashbank.*, transaksi_bank.created_at AS 'tgl',transaksi_bank.*, santri.* FROM transaksi_bank INNER JOIN cashbank ON transaksi_bank.id_cashbank = cashbank.id_cashbank INNER JOIN santri ON cashbank.id_santri = santri.id_santri WHERE cashbank.id_cashbank = '$id_cashbank' AND transaksi_bank.jenis = 'penarikan'");
                                    ...
                                    <tr>
                                      ...
                                      <div class="d-inline-block">
                                        <button class="btn btn-sm btn-primary dropdown-toggle hide-arrow" data-bs-toggle="dropdown">Pilih <i class="bx bx-dots-vertical-rounded"></i></button>
                                        <div class="dropdown-menu dropdown-menu-end">
                                          <a href="func/hapustransbank.php?id_cashbank=<?=$trk['id_cashbank'];?>&idsan=<?=$idsan;?>&nis=<?=$nis;?>&id_trans=<?=$trk['id_trans_bank'];?>" onclick="return confirm('Apakah Anda Yakin Menghapus Transaksi Ini?')" class="dropdown-item text-danger delete-record">Hapus</a>
                                        </div>
                                      </div>
                                      </td>
                                    </tr>
  ...
  <div class="modal-dialog modal-dialog-centered1 modal-simple modal-add-new-cc">
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body">
        ...
        <form class="row g-3" action="func/addsetor.php" method="POST">
            <input type="hidden" name="idsan" value="<?=$idsan;?>">
            <input type="hidden" name="id_cashbank" value="<?=$id_cashbank;?>">
  ...
  <div class="modal-dialog modal-dialog-centered1 modal-simple modal-add-new-cc">
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body">
        ...
        <form class="row g-3" action="func/addtarik.php" method="POST">
            <input type="hidden" name="idsan" value="<?=$idsan;?>">
            <input type="hidden" name="id_cashbank" value="<?=$id_cashbank;?>">
            <input type="hidden" name="nis" value="<?=$nis;?>">
          <div class="col-12">

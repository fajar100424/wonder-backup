            ...
            <div class="card mb-4">
                <div class="card-header">
                    <div class="col-md-12">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class='bx bx-book'></i> Tahfidz</a></li>
                      ...
                      <div class="card-body">
                          ...
                          <div class="tab-content">
                              ...
                              <ul class="nav nav-pills flex-column flex-sm-row mb-4">
                                  ...
                                  <li class="nav-item mr-5" style="margin-right: 5px;margin-bottom:5px;"><a class="nav-link active btn btn-lg" href="mattahfidz.php?idsan=<?=$idsan;?>&nis=<?=$nis;?>&id_jadwal=<?=$mpl['id_jadwal'];?>&id_mapel=<?=$mpl['id_mapel'];?>"><i class='bx bx-book'></i><?=ucwords($mpl['mapel']);?></a></li>
                                  <?php endforeach; ?>
                              </ul>
                              <?php } else {?>

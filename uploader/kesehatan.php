...
if ($rowsan['NIS'] !== NULL && $rowsan['NIK'] !== NULL && $rowsan['id_kamar'] !== NULL) {
  ...
  $totpenyakitq = query("SELECT COUNT(id_riwayat_penyakit) AS 'totpenyakit' FROM penyakit WHERE id_santri = '$idsan';")[0];
  $totpenyakit = $totpenyakitq['totpenyakit'];
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <div class="col-md-12">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class='bx bx-plus-medical'></i> Kesehatan</a></li>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                            <li class="nav-item">
                            <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-justified-home" aria-controls="navs-pills-justified-home" aria-selected="true"><i class="tf-icons bx bx-book"></i>Tambah Riwayat Kesehatan Santri</button>
                            </li>
                            <li class="nav-item">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-justified-profile" aria-controls="navs-pills-justified-profile" aria-selected="false"><i class="tf-icons bx bx-notepad"></i>Riwayat Kesehatan Santri <span class="badge rounded-pill badge-center h-px-20 w-px-20 bg-danger"><?=$totpenyakit;?></span></button>
                            </li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="navs-pills-justified-home" role="tabpanel">
                            <form action="func/addkesehatan.php" id="formAccountSettings" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="mb-2 col-md-6">
                                            <label class="form-label" for="sakit">Sakit <span class="text-danger">*</span></label>
                                            <div class="input-group input-group-merge">
                                                <span id="basic-icon-default-message2" class="input-group-text"><i class="bx bx-user"></i></span>
                                                <input type="text" name="sakit" id="sakit" class="form-control" placeholder="Sakit yang Diderita Santri" required />
                                            </div>
                                            </div>
                                            <div class="mb-2 col-md-6">
                                            <label class="form-label" for="penanganan">Penanganan <span class="text-danger">*</span></label>
                                            <div class="input-group input-group-merge">
                                                <span id="basic-icon-default-message2" class="input-group-text"><i class="bx bx-user"></i></span>
                                                <input type="text" name="penanganan" id="penanganan" class="form-control" placeholder="Penanganan yang Diberikan" required />
                                            </div>
                                            </div>
                                            <div class="mb-2 col-md-6"></div>
                                            <div class="mb-3 col-md-12">
                                            <label class="form-label" for="keterangan">Keterangan Sakit <span class="text-danger">*</span></label>
                                            <div class="input-group input-group-merge">
                                                <span id="basic-icon-default-phone2" class="input-group-text"><i class="bx bx-comment"></i></span>
                                                <textarea name="keterangan" id="" cols="3" rows="3" class="form-control" placeholder="Keterangan Sakit yang Diderita Santri"></textarea>
                                            </div>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="navs-pills-justified-profile" role="tabpanel">
                                ...
                                <table id="mansakit" class="table table-responsive table-bordered">
                                <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Tanggal</th>
                                ...
                                <?php
                                    $i =1;
                                    $kesehatan = query("SELECT * FROM penyakit WHERE id_santri = '$idsan'");
                                    foreach ($kesehatan as $ksht) :?>
                                    <tr>
                                    <td><?=$i;?></td>
                                    <td><?=date('l, d F Y', strtotime($ksht["tanggal"]));?></td>
                                    <td><?=ucwords($ksht['penyakit']);?></td>
                                    <td><?=ucwords($ksht['penanganan']);?></td>
                                    <td><?=ucwords($ksht['keterangan']);?></td>
                                    <td>
                                    <div class="d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="func/hapuskesehatan.php?id=<?=$ksht['id_riwayat_penyakit'];?>&idsan=<?=$idsan;?>" onclick="return confirm('Apakah Anda Yakin Menghapus Riwayat Penyakit Ini?')" class="dropdown-item text-danger delete-record">Hapus</a>
                                        </div>
                                    </div>
                                    </td>
                                    </tr>

...
<!-- / Navbar -->
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <div class="col-md-12">
                            ...
                            <li class="nav-item"><a class="nav-link" href="suluk.php?idsan=<?=$idsan;?>"><i class='bx bx-pencil'></i> Suluk</a></li>
                            <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class='bx bx-car'></i> Kunjungan</a></li>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                            <li class="nav-item">
                            <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-justified-home" aria-controls="navs-pills-justified-home" aria-selected="true"><i class="tf-icons bx bx-book"></i>Tambah Kunjungan</button>
                            </li>
                            <li class="nav-item">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-justified-profile" aria-controls="navs-pills-justified-profile" aria-selected="false"><i class="tf-icons bx bx-notepad"></i>Laporan Kunjungan Santri <span class="badge rounded-pill badge-center h-px-20 w-px-20 bg-danger"><?=$countkunjungan['jumkunj'];?></span></button>
                            </li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="navs-pills-justified-home" role="tabpanel">
                            <form action="func/addkunjungan.php" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="mb-2 col-md-6">
                                            <label class="form-label" for="basic-icon-default-phone">Pukul <span class="text-danger">*</span></label>
                                            <div class="input-group input-group-merge">
                                                <span id="basic-icon-default-phone2" class="input-group-text"><i class="bx bx-calendar"></i></span>
                                                <input type="time" name="pukul" class="form-control" placeholder="Contoh 12.00"/>
                                            </div>
                                            </div>
                                            
                                            <div class="mb-2 col-md-6">
                                            <label class="mb-3 mt-3 form-label" for="mahram">Penjenguk <span class="text-danger">*</span></label>
                                            <button type="button" class="ml-3 btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addNewMahram"> Tambah Mahram + </button>
                                                <?php
                                                $mahram = query("SELECT * FROM mahram WHERE id_santri = '$idsan'");;
                                                foreach ($mahram as $mhr) :?>
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="mahram[]" type="checkbox" value="<?=$mhr['nama'];?>"/>
                                                        <label class="form-check-label">
                                                            <?=ucwords($mhr['nama'].' ('.$mhr['posisi'].')');?>
                                                        </label>
                                                    </div>
                                                <?php endforeach;?>
                                            </div>
                                            
                                            <span><small><span class="text-danger">*</span>) Hati-hati dalam mengonfirmasi kunjungan santri.</small></span>
                                            
                                        </div>
                                        <div class="mt-2">
                                            <button type="submit" name="simpan" class="btn btn-primary me-2">Simpan &raquo;<i class="bx bx-send"></i></button>
                                ...
                                <tbody>
                                    ...
                                    <div class="d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="func/hapuskunjungan.php?id=<?=$kjg['id_kunjungan'];?>&idsan=<?=$idsan;?>" onclick="return confirm('Apakah Anda Yakin Menghapus Kunjungan Ini?')" class="dropdown-item text-danger delete-record">Hapus</a>
                                        </div>
                                    </div>
                                    </td>
                                    </tr>
    ...
    <!-- / Content -->
          ...
          <!-- Add New Mahram -->
<div class="modal fade" id="addNewMahram" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered1 modal-simple modal-add-new-cc">
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body">
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        <div class="text-center mb-4">
          <h3>Tambah Data Mahram</h3>
          <p>Mahram Ananda <?=ucwords($santri['fullname']);?></p>
        </div>
        <form class="row g-3" action="func/addmahram.php" method="POST">
            <input type="hidden" name="id_santri" value="<?=$idsan;?>">
          <div class="col-12">
            <label class="form-label w-100" for="nama">Nama Mahram <span class="text-danger">*</span></label>
            <input id="nama" name="nama" class="form-control" type="text" placeholder="Masukkan Nama Mahram"/>
          </div>
          <div class="col-12 col-md-12">
            <label class="form-label" for="posisi">Hubungan Dengan Santri <span class="text-danger">*</span></label>
            <input type="text" id="posisi" name="posisi" class="form-control" placeholder="Misalkan Ayah Kandung" />
          </div>

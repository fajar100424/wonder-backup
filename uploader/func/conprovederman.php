...
<html>
    ...
    <body>
        <?php
            if (isset($_POST)) {
                if (tambahprove($_POST) > 0) {
                    echo "<script>swal('Berhasil Mengirim Bukti Transfer!', 'Terima Kasih Telah Menggunakan SIM Donatur Online Pondok Trendi!', 'success').then(function(){

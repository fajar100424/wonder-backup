...
<html>
    ...
    <body>
        ...
        $idsan = $_POST['id_santri'];
            if (isset($_POST)) {
                if (addsuluk($_POST) > 0) {
                    echo "<script>swal('Tambah Suluk Berhasil!', 'Terima Kasih Telah Menggunakan Sistem Informasi Pondok Pesantren!', 'success').then(function(){
                        setTimeout(document.location.href = '../suluk.php?idsan=$idsan', 100);
                        });</script>";
                }else {
                    echo "<script>swal('Gagal Menambahkan Suluk','Silakan Periksa Kembali !','error').then(function(){
                        setTimeout(document.location.href = '../suluk.php?idsan=$idsan', 100);
                    });</script>";
                }
            }else {

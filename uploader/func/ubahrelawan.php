    ...
    <body>
        <?php
            if (isset($_POST)) {
                ...
                if (ubahrelawan($_POST) > 0) {
                    echo "<script>swal('Ubah Relawan Berhasil!', 'Terima Kasih Telah Menggunakan SIM Donatur Online Pondok Trendi!', 'success').then(function(){
                        setTimeout(document.location.href = '../manpegawai.php', 100);
                        });</script>";
                }else {
                    echo "<script>swal('Gagal Mengubah Relawan','Silakan Periksa Kembali !','error').then(function(){

...
<head>
    ...
    <title>Tambah Data Bank Santri | Trendi</title>
        ...
        <div class="navbar-nav align-items-center">
          <div class="nav-item navbar-search-wrapper mb-0">
            <a class="nav-item nav-link px-0">
              ...
              <span>
                <b>Tambah Massal Tabungan Bank Santri</b> 
              </span>
...
<!-- / Navbar -->
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                  <li class="nav-item">
                    <button type="button" class="nav-link active"><i class="tf-icons bx bx-home"></i> Buat Tabungan Bank Santri</button>
                  </li>
              </ul>
            </div>
            <div class="card-body">
            ...
            <div class="d-flex flex-column ps-1">
                ...
                <span>Jika ada siswa yang telah dibuatkan tabungan bank pada tahun ajaran dan kelas yang sama maka akan gagal!</span>
            </div>
            </div>
            <hr>
            <form action="func/massalcashbank.php" method="POST">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-8">
                        ...
                        <div class="card-datatable table-responsive">
                            ...
                            <tbody>
                                <?php
                                $i=1;
                                $santri = query("SELECT santri.*,kelas_santri.*,kelas.* FROM kelas_santri INNER JOIN santri ON kelas_santri.NIS = santri.NIS INNER JOIN kelas ON kelas_santri.id_kelas = kelas.id_kelas WHERE kelas_santri.id_kelas = '$idkelas' AND NOT EXISTS (SELECT cashbank.* FROM cashbank  WHERE cashbank.id_santri = santri.id_santri)");

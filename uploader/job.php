...
<head>
    ...
    <title>Amanah dan Tugas | SISPPI</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="col-lg-12 col-md-12 col-12 mb-4">
            <div class="card">
              ...
              <h5 class="p">Manajemen Amanah & Tugas</h5>
                <form action="func/addjob.php" method="POST">
                  <div class="row">
                    <div class="col-lg-6">
                      <input type="text" name="unit" class="form-control-md form-control" placeholder="Nama Unit" required>
                      </div>
                      <div class="col-lg-3">
                      <input type="text" name="job" class="form-control-md form-control" placeholder="Amanah/Tugas" required>
                      </div>
                      <div class="col-lg-3">
              ...
              <div class="nav-align-top mb-4">
                <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                  <li class="nav-item">
                    <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-justified-home" aria-controls="navs-pills-justified-home" aria-selected="true"><i class="tf-icons bx bx-home"></i> Daftar Amanah & Tugas<span class="badge rounded-pill badge-center h-px-20 w-px-20 bg-danger"><?=$countpoint[0]['jumpoint'];?></span></button>
                  </li>
                </ul>

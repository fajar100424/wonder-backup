...
<head>
    ...
    <title>Edit Profile | SISPPI</title>
                ...
                <a class="dropdown-item" href="pages-account-settings-account.html">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      <span class="fw-semibold d-block"><?=ucwords($row['fullname']);?></span>
      ...
      <div class="content-wrapper">
        ...
        <div class="card">
            ...
            <div class="col-md-12">
                    ...
                    <li class="nav-item"><a class="nav-link" href="profile.php"><i class='bx bx-user'></i> Profile</a></li>
                    <li class="nav-item"><a class="nav-link active" href="editprof.php"><i class='bx bx-wrench'></i> Edit</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="assets/img/avatars/<?=$row['gambar'];?>" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
                        ...
                        <br>
                            ...
                            <div class="row">
                                ...
                                <input class="form-control" type="email" id="email" name="email" placeholder="contoh@gmail.com" value="<?=$row['email'];?>" disabled/>
                                </div>
                                <div class="mb-3 col-md-6">
                                <label for="fullname" class="form-label">Nama Lengkap <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" id="fullname" name="fullname" placeholder="Nama Lengkap" value="<?=$row['fullname'];?>" disabled autofocus/>
                                </div>
                                <div class="mb-3 col-md-6">
                                <label for="notelp" class="form-label">No. Telepon (WA) <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" id="notelp" name="notelp" placeholder="Nomor Telepon" value="<?= $row['notelp'];?>" autofocus/>
                                </div>
                                <div class="mb-3 col-md-6">
                                <label for="alamat" class="form-label">Alamat <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" id="alamat" name="alamat" placeholder="Alamat" value="<?=$row['alamat'];?>" autofocus/>
                                </div>

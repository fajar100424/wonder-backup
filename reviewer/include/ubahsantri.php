...
<head>
    ...
    <title>Ubah Santri | SISPPI</title>
...
$tgl = date('Y-m');
$idsantri = $_GET['id'];
$santri = query("SELECT * FROM santri WHERE id_santri = '$idsantri'")[0];
    ...
    <div class="content-wrapper">
          ...
          <div class="col-lg-12 col-md-12 col-12 mb-4">
            <div class="card">
              <div class="card-header">
                <h5 class="p">Ubah Data Ananda <?=ucwords($santri['fullname']);?></h5>
                <hr>
              </div>
              <div class="card-body">
              <form id="formValidationExamples" action="func/ubahsantri.php" method="POST" enctype="multipart/form-data" class="row g-3">
              <input class="form-control" type="hidden" name="id" value="<?=$santri['id_santri'];?>">
              <input class="form-control" type="hidden" name="gambarLama" value="<?= $santri['gambar']; ?>">
              <small class="text-light fw-semibold">Ubah Data Santri Dengan Baik dan Benar ( <span class="text-danger">*</span> )</small>
                <!-- Account Details -->
                ...
                <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="assets/img/avatars/<?=$santri['gambar'];?>" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
                ...
                <div class="col-sm-6">
                  ...
                  <input type="text" id="fullname" name="fullname" class="form-control" value="<?=$santri['fullname'];?>" />
                </div>
                
                <div class="col-sm-12">
                  <label class="form-label" for="bs-validation-bio">Alamat</label>
                  <textarea class="form-control" id="bs-validation-bio" name="alamat" rows="3"><?=$santri['alamat'];?></textarea>
                </div>
                <!-- <div class="col-sm-6"></div> -->
                <div class="col-sm-12">
                  <label class="form-label" for="status">Status</label>
                  <div class="form-check">
                    <input type="radio" id="nonaktif" name="status" value="nonaktif" class="form-check-input" <?php if ($santri["status"] === 'nonaktif') {echo "checked";} else {echo " ";}?>/>
                    <label class="form-check-label" for="nonaktif">Tidak Aktif</label>
                  </div>
                  <div class="form-check">
                    <input type="radio" id="aktif" name="status" value="aktif" class="form-check-input" <?php if ($santri["status"] === 'aktif') {echo "checked";} else {echo " ";}?>/>
                    <label class="form-check-label" for="aktif">Aktif</label>
                  </div>
                  <div class="form-check">
                    <input type="radio" id="tamat" name="status" value="tamat" class="form-check-input" <?php if ($santri["status"] === 'tamat') {echo "checked";} else {echo " ";}?>/>
                    <label class="form-check-label" for="tamat">Tamat</label>
                  </div>
                  <div class="form-check">
                    <input type="radio" id="pindah" name="status" value="pindah" class="form-check-input" <?php if ($santri["status"] === 'pindah') {echo "checked";} else {echo " ";}?>/>
                    <label class="form-check-label" for="pindah">Pindah Pesantren</label>
                  </div>
                  <div class="form-check">
                    <input type="radio" id="do" value="do" name="status" class="form-check-input" <?php if ($santri["status"] === 'do') {echo "checked";} else {echo " ";}?>/>
                ...
                <div class="col-sm-6">
                  ...
                  <input type="text" disabled id="NIS" class="form-control" name="NIS" value="<?=$santri['NIS'];?>"/>
                </div>
                <div class="col-sm-6"></div>
                          ...
                          <div class="col-sm-6">
                            ...
                            <select class="select2" id="kategori" name="kategori">
                              ...
                              <?php
                                    ...
                                    <option value="<?=$ktg['id_kategori'];?>" <?php if ($santri["id_kategori"] == $ktg['id_kategori']) {echo "selected";} else {echo " ";}?>><?=ucwords($ktg['kategori']);?></option>
                                    <?php endforeach;?>
                            </select>
                          </div>
                ...
                <div class="col-sm-6">
                  ...
                  <input type="text" id="waortu" name="waortu" class="form-control" placeholder="No.Handphone Orang Tua" value="<?=$santri['waortu'];?>"/>
                </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-12 mb-4">
                <div class="card">
                <div class="card-header">
                    <h5 class="p">Ubah Password Santri</h5>
                    <hr>
                </div>
                <div class="card-body">
                    <form action="func/ubahpasssantri.php" id="formAccountSettings" method="POST" enctype="multipart/form-data">
                            <input class="form-control" type="hidden" name="id" value="<?=$santri['id_santri'];?>">
                                <div class="row">

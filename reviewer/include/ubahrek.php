...
$tgl = date('Y-m');
$idrek = $_GET['id'];
$rek = query("SELECT * FROM rekening WHERE id_rekening = '$idrek'")[0];
          ...
          <div class="col-lg-12 col-md-12 col-12 mb-4">
            <div class="card">
              <div class="card-header">
                <h5 class="p">Ubah Rekening</h5>
                <hr>
              </div>
              <div class="card-body">
              <form action="func/ubahrek.php" id="formAccountSettings" method="POST" enctype="multipart/form-data">
                        <input class="form-control" type="hidden" name="id" value="<?=$rek['id_rekening'];?>">
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                <label class="form-label" for="rek">Rekening Atas Nama<span class="text-danger">*</span></label>
                                <div class="input-group input-group-merge">
                                    <input class="form-control" type="text" id="rek" name="rekening" placeholder="" value="<?=ucwords($rek['atasnama']);?>" required/>
                                </div>
                                </div>
                                <div class="mb-3 col-md-6">
                                <label class="form-label" for="bank">Bank<span class="text-danger">*</span></label>
                                <div class="input-group input-group-merge">
                                    <input class="form-control" type="text" id="bank" name="bank" placeholder="" value="<?=ucwords($rek['bank']);?>" required/>
                                </div>
                                </div>
                                <span><small><span class="text-danger">*</span>) Hati-Hati Dalam Mengubah Rekening.</small></span>
                                
                            </div>
                            <div class="mt-2">
                                <button type="submit" class="btn btn-primary me-2">Ubah <i class="bx bx-send"></i></button>
                                <button type="reset" class="btn btn-label-secondary"> <a href="mandonatur.php"> Batal <i class="bx bx-refresh"></i></a></button>
                            </div>
                            </form>

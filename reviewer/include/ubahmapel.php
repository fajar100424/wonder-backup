          ...
          <div class="col-lg-12 col-md-12 col-12 mb-4">
            <div class="card">
              <div class="card-header">
                <h5 class="p">Ubah Mapel Santri</h5>
                <hr>
              </div>
              <div class="card-body">
                <form action="func/ubahmapel.php" id="formAccountSettings" method="POST" enctype="multipart/form-data">
                        <input class="form-control" type="hidden" name="idmapel" value="<?=$mapel['id_mapel'];?>">
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                <label class="form-label" for="mapel">Nama Mapel <?=$mapel['mapel'];?><span class="text-danger">*</span></label>
                                <div class="input-group input-group-merge">
                                    <input type="text" class="form-control" id="mapel" name="mapel" value="<?=$mapel['mapel'];?>"/>
                                </div>
                                </div>
                                <div class="mb-3 col-md-6">
                                <label class="form-label" for="kode_mapel">Kode Mapel<span class="text-danger">*</span></label>
                                <div class="input-group input-group-merge">
                                    <input class="form-control" type="text" id="kode_mapel" name="kode_mapel" placeholder="" value="<?=ucwords($mapel['kode_mapel']);?>"/>
                                </div>
                                </div>
                                <div class="mb-3 col-md-6">
                                    ...
                                    $pengajar = query("SELECT * FROM users");
                                    foreach ($pengajar as $pj) :?>
                                    <option value="<?=$pj['id_user']?>" <?php if ($pj['id_user'] == $id_pengajar) {
                                        echo "selected";
                                    } ?>><?=ucwords($pj['fullname']);?></option>
                                    <?php endforeach;?>
                                    </select>
                                </div>
                                <span><small><span class="text-danger">*</span>) Hati-Hati Dalam Mengubah Mapel Santri.</small></span>
                            </div>
                            <div class="mt-2">

...
$tgl = date('Y-m');
$idkategori = $_GET['id'];
$kategori = query("SELECT * FROM kategori WHERE id_kategori = '$idkategori'")[0];
          ...
          <div class="col-lg-12 col-md-12 col-12 mb-4">
            <div class="card">
              <div class="card-header">
                <h5 class="p">Ubah Kategori Santri</h5>
                <hr>
              </div>
              <div class="card-body">
                <form action="func/ubahkategori.php" id="formAccountSettings" method="POST" enctype="multipart/form-data">
                        <input class="form-control" type="hidden" name="id" value="<?=$kategori['id_kategori'];?>">
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                <label class="form-label" for="kategori">Kategori<span class="text-danger">*</span></label>
                                <div class="input-group input-group-merge">
                                    <input class="form-control" type="text" id="kategori" name="kategori" placeholder="" value="<?=ucwords($kategori['kategori']);?>" required/>
                                </div>
                                </div>
                                
                                <span><small><span class="text-danger">*</span>) Hati-Hati Dalam Mengubah Kategori Santri.</small></span>

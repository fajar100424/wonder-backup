...
$id_bulan_pay = $_GET['id'];
$id_santri = $_GET['id_santri'];
$bulanpay = query("SELECT bulan_pay.*, payment.*,bulan.* FROM bulan_pay INNER JOIN payment ON bulan_pay.payment_id = payment.payment_id INNER JOIN bulan ON bulan_pay.id_bulan = bulan.id_bulan WHERE bulan_pay.id_bulan_pay = '$id_bulan_pay'")[0];
        ...
        <div class="row">
            ...
            <div class="nav-align-top mb-4">
              ...
              <div class="tab-content">
                ...
                <form action="func/kirimbuktibulan.php" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="id_bulan_pay" value="<?=$id_bulan_pay;?>">
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" class="form-control" disabled name="bayar" value="<?=ucwords($bulanpay['pembayaran'].' Bulan '.$bulanpay['bulan']);?>">
                    </div>
                  </div>
                  <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" class="form-control" name="dibayar" disabled value="<?=rupiah($bulanpay['bulan_pay']);?>">
                    </div>
                  </div>
                <div class="mb-3">

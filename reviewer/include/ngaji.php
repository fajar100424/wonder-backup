...
<head>
    ...
    <title>Kelompok Ngaji Santri | SISPPI</title>
...
$id_kelompok = $_GET['idgroup'];
$kelompok = query("SELECT * FROM kelompok WHERE id_kelompok = '$id_kelompok'")[0];
$santri = query("SELECT santri.*,santri.status AS 'stats_santri', kelas_santri.* , kelas.*, kamar.*,kelompok.*,kelompok_santri.* FROM kelompok_santri INNER JOIN kelompok ON kelompok_santri.id_kelompok = kelompok.id_kelompok INNER JOIN santri ON kelompok_santri.id_santri = santri.id_santri INNER JOIN kelas_santri ON santri.NIS = kelas_santri.NIS INNER JOIN kelas ON kelas_santri.id_kelas = kelas.id_kelas INNER JOIN kamar ON santri.id_kamar = kamar.id_kamar WHERE kelompok_santri.id_kelompok = '$id_kelompok';");  


$totsan = query("SELECT COUNT(id_kelompok_santri) AS 'totsan' FROM kelompok_santri")[0];
$tgl = date('Y-m');
        ...
        <div class="navbar-nav align-items-center">
          <div class="nav-item navbar-search-wrapper mb-0">
            <a class="nav-item nav-link px-0">
              ...
              <span>
                <b>Daftar Santri Kelompok <?=ucwords($kelompok['kelompok']);?></b> 
              </span>
            ...
            <div class="card">
              ...
              <div class="nav-align-top mb-4">
                <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                  <li class="nav-item">
                    <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-justified-home" aria-controls="navs-pills-justified-home" aria-selected="true"><i class="tf-icons bx bx-home"></i> Daftar Santri Kelompok <?=ucwords($kelompok['kelompok']);?> <span class="badge rounded-pill badge-center h-px-20 w-px-20 bg-danger"><?=$totsan['totsan'];?></span></button>
                  </li>
                </ul>
                <div class="tab-content">
                  <div class="tab-pane fade show active" id="navs-pills-justified-home" role="tabpanel">
                  <a href="group.php" class="btn btn-sm btn-primary text-nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><span class="badge bg-label-success" style="font-size: large;">
                          <a href="groupsan.php?idkelompoksantri=<?=$san['id_kelompok_santri'];?>&idsan=<?=$san['id_santri'];?>&nis=<?=$san['NIS'];?>"><?=$san['NIS'];?></a>
                        </span></td>
                        ...
                        <div class="d-inline-block">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-end">
                                    <a href="func/hapusgroupsan.php?id=<?=$san['id_kelompok_santri'];?>&idgroup=<?=$san['id_kelompok'];?>" onclick="return confirm('Apakah Anda Yakin Menghapus Santri Ini Dari Kelompok Ini?')" class="dropdown-item text-danger delete-record">Hapus</a>
                                  </div>
                                </div>
                        </td>
                      </tr>

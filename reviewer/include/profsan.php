                ...
                <div class="card-header">
                    <div class="col-md-12">
                            <ul class="nav nav-pills flex-column flex-sm-row mb-4">
                              <li class="mb-4 nav-item"><a class="nav-link active" href="index.php?page=12&idsan=<?=$idsan;?>"><i class='bx bx-user'></i>Catatan Santri</a></li>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                            <li class="nav-item">
                            <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-justified-profile" aria-controls="navs-pills-justified-profile" aria-selected="false"><i class="tf-icons bx bx-notepad"></i>Laporan Catatan Santri <span class="badge rounded-pill badge-center h-px-20 w-px-20 bg-danger"><?=$countcatatan['jumcatatan'];?></span></button>
                            </li>
                        </ul>

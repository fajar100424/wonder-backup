        ...
        <?php
            ...
            if (isset($_POST)) {
                if (ubahjenis($_POST) > 0) {
                    echo "<script>swal('Ubah Jenis Donasi Berhasil!', 'Terima Kasih Telah Menggunakan SIM Donatur Online Pondok Trendi!', 'success').then(function(){
                        setTimeout(document.location.href = '../mandonatur.php', 100);
                        });</script>";
                }else {
                    echo "<script>swal('Gagal Mengubah Jenis Donasi','Silakan Periksa Kembali !','error').then(function(){
                        setTimeout(document.location.href = '../ubahjen.php?id=$idjenis', 100);
                    });</script>";
                }
            }else {
                echo "<script>swal('Gagal Mengubah Jenis Donasi','Silakan Periksa Kembali !','error').then(function(){

        ...
        <?php
            if (isset($_POST)) {
                ...
                if (ubahsantri($_POST) > 0) {
                    echo "<script>swal('Ubah Santri Berhasil!', 'Terima Kasih Telah Menggunakan Sistem Informasi Santri Pondok Trendi!', 'success').then(function(){
                        setTimeout(document.location.href = '../santri.php', 100);
                        });</script>";
                }else {
                    echo "<script>swal('Gagal Mengubah Santri!','Silakan Periksa Kembali !','error').then(function(){

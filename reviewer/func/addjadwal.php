        ...
        <?php
            if (isset($_POST)) {
                ...
                if (addjadwal($_POST) > 0) {
                    echo "<script>swal('Tambah Jadwal Berhasil!', 'Terima Kasih Telah Menggunakan Sistem Informasi Santri Pondok Trendi!', 'success').then(function(){
                        setTimeout(document.location.href = '../jadwal.php?kelas=$idkelas', 100);
                        });</script>";
                }else {
                    echo "<script>swal('Gagal Menambahkan Jadwal','Silakan Periksa Kembali !','error').then(function(){
                        setTimeout(document.location.href = '../jadwal.php?kelas=$idkelas', 100);
                    });</script>";
                }
            }else {

          ...
          <div class="col-lg-12 col-md-12 col-12 mb-4">
            <div class="card">
              <div class="card-header">
                <h5 class="p">Tambah User Baru</h5>
                <hr>
              </div>
              <div class="card-body">
                <form action="func/adduser.php" id="formAccountSettings" method="POST" enctype="multipart/form-data">
                        ...
                        <br>
                            ...
                            <div class="row">
                                ...
                                <input class="form-control" type="email" id="email" name="email" placeholder="contoh@gmail.com" autofocus required/>
                                </div>
                                <div class="mb-3 col-md-6">
                                <label for="fullname" class="form-label">Nama Lengkap <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" id="fullname" name="fullname" placeholder="Nama Lengkap" autofocus required/>
                                </div>
                                <div class="mb-3 col-md-6">
                                <label for="notelp" class="form-label">No. Telepon (WA) <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" id="notelp" name="notelp" placeholder="Nomor Telepon" autofocus required/>
                                </div>
                                <div class="mb-3 col-md-6">
                                <label for="alamat" class="form-label">Alamat <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" id="alamat" name="alamat" placeholder="Alamat" autofocus required/>
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                <label for="unit" class="form-label">Hak Akses (Unit)<span class="text-danger">*</span></label>
                                <select name="unit" id="unit" required class="select2 form-select">
                                    <option value="">-- Pilih Unit --</option>
                                    <?php
                                    $unit = query("SELECT * FROM unit");
                                    foreach ($unit as $unt) :?>
                                    <option value="<?=$unt['id_unit'];?>"><?=ucwords($unt['unit']);?></option>
                                    <?php endforeach;?>
                                </select>
                                </div>
                                <div class="mb-3 col-md-6">

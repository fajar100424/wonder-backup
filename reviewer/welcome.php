    ...
    <div class="col-lg-12">
        <div class="card mb-4">
            ...
            <div class="col-sm-5 text-center text-sm-left">
                ...
                <img src="assets/img/illustrations/man-with-laptop-light.png" height="140" alt="View Badge User" data-app-light-img="illustrations/man-with-laptop-light.png" data-app-dark-img="illustrations/man-with-laptop-dark.html">
                </div>
            </div>
            </div>
        </div>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="datapribadi" role="tabpanel">
                        ...
                        <div class="card-body">
                            ...
                            <hr>
                            <form action="func/updatedatapribadi.php" method="POST">
                            <input type="hidden" name="id_santri" value="<?=$idsan;?>">
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="number" id="anakke" name="anakke" class="form-control" value="<?=$datapribadi['anakke'];?>"/>
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="form-label" for="jumlahsaudara">Jumlah Saudara</label>
                                        <input type="number" id="jumlahsaudara" name="jumlahsaudara" class="form-control" value="<?=$datapribadi['jumlah_saudara'];?>"/>
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="form-label" for="nis">NISN (Nomor Induk Siswa Nasional) <span class="text-danger">*)</span></label>
                                        <input type="text" id="nis" name="nis" class="form-control" value="<?=$datapribadi['NIS'];?>"/>
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="form-label" for="nik">NIK (Nomor Induk Kependudukan) <span class="text-danger">*)</span></label>
                                        <input type="text" id="nik" name="nik" class="form-control" value="<?=$datapribadi['NIK'];?>"/>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="checkbox" class="switch-input" name="formValidationSwitch" required/>
                                        <span class="switch-toggle-slider">
                                        <span class="switch-on"></span>
                                        <span class="switch-off"></span>
                                        </span>
                                        <span class="switch-label">Saya dengan yakin mengubah data santri dengan benar dan sadar ( <span class="text-danger">*</span> )</span>
                                        </label>
                                    </div>
                                    <button type="submit" name="subdatapri" value="simpan" class="btn btn-danger"> <i class="bx bx-upload"></i> Perbarui Data</button>
                                </div>
                            </form>
                    ...
                    <div class="tab-pane fade" id="datasekolah" role="tabpanel">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                            <form action="func/updatedataschool.php" method="POST">
                                <input type="hidden" name="id_santri" value="<?=$idsan;?>">
                                <div class="row g-3">
                                    <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="form-check custom-option custom-option-icon">
                                            ...
                                            <input name="status_sekolah" class="form-check-input" type="radio" value="negeri" id="customRadioSell" <?php if ($datasekolah['status_sekolah'] === "negeri") {
                                                echo "checked";
                                            } ?>/>
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-check custom-option custom-option-icon">
                                            ...
                                            <input name="status_sekolah" class="form-check-input" type="radio" value="swasta" id="customRadioRent" <?php if ($datasekolah['status_sekolah'] === "swasta") {
                                                echo "checked";
                                            } ?>/>
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" id="nama_sekolah" name="nama_sekolah" class="form-control" value="<?=$datasekolah['nama_sekolah'];?>"/>
                                    </div>
                                    <div class="col-lg-12">
                                        <label class="form-label" for="alamat_sekolah">Alamat Sekolah Asal</label>
                                        <textarea id="alamat_sekolah" name="alamat_sekolah" class="form-control" rows="2"><?=$datasekolah['alamat_sekolah'];?></textarea>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <button type="submit" name="subdataschool" class="btn btn-danger" value="subdataschool"> <i class="bx bx-upload"></i> Perbarui Data</button>
                                </div>
                            </form>
                    ...
                    <div class="tab-pane fade" id="dataayah" role="tabpanel">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                            <form action="func/updatedataayah.php" method="POST">
                                <input type="hidden" name="id_santri" value="<?=$idsan;?>">
                                <div class="row g-3">
                                    <div class="col-sm-12">
                                    <label class="form-label d-block" for="nama_ayah">Nama Ayah <span class="text-danger">*)</span></label>
                                    <input type="text" id="nama_ayah" name="nama_ayah" class="form-control" value="<?=ucwords($dataayah['nama_ayah']);?>"/>
                                    </div>
                                    <div class="col-sm-12">
                                    <label class="form-label" for="nika">NIK <span class="text-danger">*)</span></label>
                                    <input type="number" id="nika" name="nika" class="form-control" value="<?=$dataayah['nik'];?>"/>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <small class="text-light fw-semibold">Bisa memilih lebih dari satu. Pilih Semua yang Sesuai</small>
                                        ...
                                        <input class="form-check-input" type="checkbox" name="pekerjaan_ayah[]" value="<?=$jobayahfix;?>" id="defaultCheck<?=$i;?>" checked/>
                                    ...
                                    <label class="form-label" for="notelp">Nomor Whatsapp <span class="text-danger">(Yang Dapat Dihubungi)</span></label>
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="number" name="notelp" class="form-control" value="<?=$dataayah['notelp'];?>"/>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <label class="switch switch-primary">
                                    ...
                                    <button type="submit" name="subdataayah" value="subdataayah" class="btn btn-danger"> <i class="bx bx-upload"></i> Perbarui Data</button>
                                </div>
                            </form>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="dataibu" role="tabpanel">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                            <form action="func/updatedataibu.php" method="POST">
                                <input type="hidden" name="id_santri" value="<?=$idsan;?>">
                                <div class="row g-3">
                                    <div class="col-sm-12">
                                    <label class="form-label d-block" for="nama_ibu">Nama Ibu <span class="text-danger">*)</span></label>
                                    <input type="text" id="nama_ibu" name="nama_ibu" class="form-control" value="<?=ucwords($dataibu['nama_ibu']);?>"/>
                                    </div>
                                    <div class="col-sm-12">
                                    <label class="form-label" for="nik_ibu">NIK <span class="text-danger">*)</span></label>
                                    <input type="number" id="nik_ibu" name="nik_ibu" class="form-control" value="<?=$dataibu['nik'];?>"/>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <small class="text-light fw-semibold">Bisa memilih lebih dari satu. Pilih Semua yang Sesuai</small>
                                        ...
                                        for ($i=0; $i < count($jobibu); $i++) { 
                                            ...
                                            ?>
                                        <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="pekerjaan_ibu[]" value="<?=$jobibufix;?>" id="defaultChecki<?=$i;?>" checked/>
                                        ...
                                        <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="pekerjaan_ibu[]" value="<?=$job['pekerjaan'];?>" id="defaultChecki<?=$i;?>"/>
                                        <label class="form-check-label" for="defaultChecki<?=$i;?>">
                                            <?=ucwords($job['pekerjaan']);?>
                                        </label>
                                        </div>
                                    ...
                                    <label class="form-label" for="notelp">Nomor Whatsapp <span class="text-danger">(Yang Dapat Dihubungi)</span></label>
                                        <div class="input-group input-group-merge">
                                            <span class="input-group-text">IDN (+62)</span>
                                            <input type="number" name="notelp" class="form-control" value="<?=$dataibu['notelp'];?>"/>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <label class="switch switch-primary">
                                    ...
                                    <button type="submit" name="subdataibu" value="subdataibu" class="btn btn-danger"> <i class="bx bx-upload"></i> Perbarui Data</button>
                                </div>
                            </form>
                    ...
                    <div class="tab-pane fade" id="datapenunjang" role="tabpanel">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                            <form action="func/updatedatapenunjang.php" method="POST">
                                <input type="hidden" name="id_santri" value="<?=$idsan;?>">
                                <div class="row g-3">
                                    <h4>Data Alamat Orang Tua/Wali</h4>
                                    <div class="col-sm-6">
                                    <label class="form-label" for="form_prov">Pilih Provinsi<span class="text-danger">*)</span></label>
                                    <input type="text" class="form-control" name="form_prov" id="form_prov" value="<?=ucwords($datapenunjang['provinsi']);?>">
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="form-label" for="form_kab">Pilih Kabupaten<span class="text-danger">*)</span></label>
                                        <input type="text" class="form-control" name="form_kab" id="form_kab" value="<?=ucwords($datapenunjang['kabupaten']);?>">
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="form-label" for="form_kec">Pilih Kecamatan<span class="text-danger">*)</span></label>
                                        <input type="text" class="form-control" name="form_kec" id="form_kec" value="<?=ucwords($datapenunjang['kecamatan']);?>">
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="form-label" for="form_des">Pilih Desa<span class="text-danger">*)</span></label>
                                        <input type="text" class="form-control" name="form_des" id="form_des" value="<?=ucwords($datapenunjang['kelurahan']);?>">
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="form-label" for="rtrw">RT / RW /No Rumah<span class="text-danger">*)</span></label>
                                        <input type="text" class="form-control" name="rtrw" id="rtrw" value="<?=$datapenunjang['rt']?>">
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="form-label" for="jalan">Jalan<span class="text-danger">*)</span></label>
                                        <input type="text" class="form-control" name="jalan" id="jalan" value="<?=$datapenunjang['jalan'];?>">
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="form-label" for="kodepos">Kode POS<span class="text-danger">*)</span></label>
                                        <input type="text" class="form-control" name="kodepos" id="kodepos" value="<?=$datapenunjang['kode_pos'];?>">
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="transport[]" value="<?=$transport[$i];?>" id="defaultChecktransport<?=$i;?>" checked/>
                                        ...
                                        <?php $z=0; foreach ($transportfix as $trp) {?>
                                            <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="transport[]" value="<?=$trp;?>" id="defaultChecktransport<?=$i+$z;?>"/>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <textarea id="penyakit" name="penyakit" class="form-control" rows="2"><?=$datapenunjang['penyakit'];?></textarea>
                                    </div>
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="bahasa[]" value="<?=$bahasa[$i];?>" id="defaultCheckbahasa<?=$i;?>" checked/>
                                        ...
                                        <?php $z=0; foreach ($bahasafix as $bhs) {?>
                                            <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="bahasa[]" value="<?=$bhs;?>" id="defaultCheckbahasa<?=$i+$z;?>"/>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="hobi[]" value="<?=$hobi[$i];?>" id="defaultCheckhobi<?=$i;?>" checked/>
                                        ...
                                        <?php $z=0; foreach ($hobifix as $hbi) {?>
                                            <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="hobi[]" value="<?=$hbi;?>" id="defaultCheckhobi<?=$i+$z;?>"/>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <textarea id="info" name="info" class="form-control" rows="2"><?=$datapenunjang['info'];?></textarea>
                                    </div>
                                    <div class="col-12">
                                        <label class="switch switch-primary">
                                        <input type="checkbox" class="switch-input" name="formValidationSwitch" required/>
                                    ...
                                    <button type="submit" name="subdatapenunjang" class="btn btn-danger" value="subdatapenunjang"> <i class="bx bx-upload"></i> Perbarui Data</button>
                                </div>
                            </form>
                            </div>
                        </div>
...
<div class="row" id="pemberkasan">
    ...
    <div class="mb-3 card">
            ...
            <tbody>
                ...
                <tr>
                    <?php if ($rowberkas[0]['kartu_keluarga'] !== NULL) {?>
                        <td><span class='badge bg-label-primary'><a href="assets/img/prove/<?=$rowberkas[0]['kartu_keluarga'];?>" target="_blank"><i class='bx bxs-file-blank'></i>Lihat File</a></span></td>
                    <?php }else {
                        echo "<td><span class='badge bg-label-danger'>Kosong</span></td>";
                    } ?>
                    <?php if ($rowberkas[0]['ktp_ayah'] !== NULL) {?>
                        <td><span class='badge bg-label-primary'><a href="assets/img/prove/<?=$rowberkas[0]['ktp_ayah'];?>" target="_blank"><i class='bx bxs-file-blank'></i>Lihat File</a></span></td>
                    <?php }else {
                        echo "<td><span class='badge bg-label-danger'>Kosong</span></td>";
                    } ?>
                    <?php if ($rowberkas[0]['ktp_ibu'] !== NULL) {?>
                        <td><span class='badge bg-label-primary'><a href="assets/img/prove/<?=$rowberkas[0]['ktp_ibu'];?>" target="_blank"><i class='bx bxs-file-blank'></i>Lihat File</a></span></td>
                    <?php }else {
                        echo "<td><span class='badge bg-label-danger'>Kosong</span></td>";
                    } ?>
                    <?php if ($rowberkas[0]['akta_kelahiran'] !== NULL) {?>
                        <td><span class='badge bg-label-primary'><a href="assets/img/prove/<?=$rowberkas[0]['akta_kelahiran'];?>" target="_blank"><i class='bx bxs-file-blank'></i>Lihat File</a></span></td>
                    <?php }else {
                        echo "<td><span class='badge bg-label-danger'>Kosong</span></td>";
                    } ?>
                    <?php if ($rowberkas[0]['ijazah_terakhir'] !== NULL) {?>
                        <td><span class='badge bg-label-primary'><a href="assets/img/prove/<?=$rowberkas[0]['ijazah_terakhir'];?>" target="_blank"><i class='bx bxs-file-blank'></i>Lihat File</a></span></td>
                    <?php }else {
                        echo "<td><span class='badge bg-label-danger'>Kosong</span></td>";
                    } ?>
                    <?php if ($rowberkas[0]['pas_foto'] !== NULL) {?>
                        <td><span class='badge bg-label-primary'><a href="assets/img/prove/<?=$rowberkas[0]['pas_foto'];?>" target="_blank"><i class='bx bxs-file-blank'></i>Lihat File</a></span></td>
                    <?php }else {
                        echo "<td><span class='badge bg-label-danger'>Kosong</span></td>";
                    } ?>
                    <?php if ($rowberkas[0]['skl'] !== NULL) {?>
                        <td><span class='badge bg-label-primary'><a href="assets/img/prove/<?=$rowberkas[0]['skl'];?>" target="_blank"><i class='bx bxs-file-blank'></i>Lihat File</a></span></td>
                    <?php }else {
                        echo "<td><span class='badge bg-label-danger'>Kosong</span></td>";
                    } ?>
                    <?php if ($rowberkas[0]['raport_terakhir'] !== NULL) {?>
                        <td><span class='badge bg-label-primary'><a href="assets/img/prove/<?=$rowberkas[0]['raport_terakhir'];?>" target="_blank"><i class='bx bxs-file-blank'></i>Lihat File</a></span></td>
                    <?php }else {
                        echo "<td><span class='badge bg-label-danger'>Kosong</span></td>";
                    } ?>
                    <?php if ($rowberkas[0]['bpjs'] !== NULL) {?>
                        <td><span class='badge bg-label-primary'><a href="assets/img/prove/<?=$rowberkas[0]['bpjs'];?>" target="_blank"><i class='bx bxs-file-blank'></i>Lihat File</a></span></td>
                    <?php }else {
                        echo "<td><span class='badge bg-label-danger'>Kosong</span></td>";
                    } ?>
                    <?php if ($rowberkas[0]['kip'] !== NULL) {?>
                        <td><span class='badge bg-label-primary'><a href="assets/img/prove/<?=$rowberkas[0]['kip'];?>" target="_blank"><i class='bx bxs-file-blank'></i>Lihat File</a></span></td>
                    <?php }else {
                        echo "<td><span class='badge bg-label-danger'>Kosong</span></td>";
                    } ?>
        ...
        <hr>
        <h5>Tambah/Perbarui Berkas Santri</h5>
                <form action="func/addberkas.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <input type="hidden" name="id_santri" value="<?=$idsan;?>">
                            <div class="col-sm-6 mb-2">
                                <label class="form-label" for="berkas">Jenis Berkas <span class="text-danger">*)</span></label>
                                <select class="select2" id="berkas" name="berkas" required>
                                <option value="0">--Pilih Berkas--</option>
                                <?php
                                if ($rowberkas == NULL) {?>
                                    ...
                                    <option value="ijazah_terakhir">Ijazah Terakhir</option>
                                    <option value="pas_foto">Pas Foto Berwarna</option>
                                    <option value="skl">SKL</option>
                                    <option value="raport_terakhir">Raport Terakhir</option>
                                ...
                                <?php } elseif ($rowberkas !== NULL) {
                                    ...
                                    $nama_berkas = "";
                                    foreach ($databerkas as $berkas => $value) {
                                        if ($value == NULL && $berkas !== 'id_data_berkas' && $berkas !== 'id_santri' && $berkas !== 'created_at') {
                                            switch ($berkas) {
                                                case 'kartu_keluarga':
                                                    $nama_berkas = "Kartu Keluarga";
                                                    break;
                                            ...
                                            echo "<option value='$berkas'>$nama_berkas</option>";
                                        }elseif ($value !== NULL && $berkas !== 'id_data_berkas' && $berkas !== 'id_santri' && $berkas !== 'created_at') {
                                            switch ($berkas) {
                                                case 'kartu_keluarga':
                                                    $nama_berkas = "Kartu Keluarga";
                                                    break;
                                            ...
                                            echo "<option value='$berkas'>$nama_berkas - Perbarui </option>";
                                        }
                                    }
                                } ?>
                                </select>
            ...
            <tbody>
                ...
                <?php }elseif ($rowberkasopsi !== NULL) {?>
                    <?php foreach ($rowberkasopsi as $rbk) :?>
                        ...
                        <td><span class='badge bg-label-primary'><a href="assets/img/prove/<?=$rbk['nama_berkas'];?>" target="_blank"><i class='bx bxs-file-blank'></i>Lihat File</a></span></td>
        ...
        <hr>
        <h5>Tambah Berkas Opsional Santri</h5>
                <form action="func/addberkasopsi.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-2">
                                ...
                                <input type="text" class="form-control" name="jenis_berkas">
                            </div>

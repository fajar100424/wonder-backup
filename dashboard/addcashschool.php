...
<head>
    ...
    <title>Tambah Tabungan Pondok | Trendi</title>
        ...
        <div class="navbar-nav align-items-center">
          <div class="nav-item navbar-search-wrapper mb-0">
            <a class="nav-item nav-link px-0">
              ...
              <span>
                <b>Tambah Massal Tabungan Pondok Santri</b> 
              </span>
...
<!-- / Navbar -->
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                  <li class="nav-item">
                    <button type="button" class="nav-link active"><i class="tf-icons bx bx-home"></i> Buat Tabungan Pondok Santri</button>
                  </li>
              </ul>
            </div>
            <div class="card-body">
            ...
            <div class="d-flex flex-column ps-1">
                ...
                <span>Jika ada siswa yang telah dibuatkan tabungan pondok pada tahun ajaran dan kelas yang sama maka akan gagal!</span>
            </div>
            </div>
            <hr>
            <form action="func/massalcashschool.php" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-8">
                        ...
                        <div class="card-datatable table-responsive">
                            ...
                            <tbody>
                                <?php
                                $i=1;
                                $santri = query("SELECT santri.*,kelas_santri.*,kelas.* FROM kelas_santri INNER JOIN santri ON kelas_santri.NIS = santri.NIS INNER JOIN kelas ON kelas_santri.id_kelas = kelas.id_kelas WHERE kelas_santri.id_kelas = '$idkelas' AND NOT EXISTS (SELECT cashschool.* FROM cashschool  WHERE cashschool.id_santri = santri.id_santri)");
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4">
                        ...
                        <div class="card-header">
                            <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                                    <li class="nav-item">
                                    <button type="button" class="nav-link active"><i class="tf-icons bx bx-home"></i> Data Tabungan</button>
                                    </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                <label class="form-label" for="kelaspil">Saldo Awal <span class="text-danger">*</span></label>
                                <div class="input-group input-group-merge">
                                    <span id="kelaspil" class="input-group-text"><i class="bx bx-money"></i></span>
                                    <input type="text" class="form-control" name="saldo" placeholder="Rp.100.000">
                                </div>
                                </div>
                                <div class="col-md-12" style="margin-top: 30px;">
                                    <button type="submit" class="btn btn-danger me-2">Proses Buat Tabungan <i class="bx bx-plus"></i></button>
                                </div>
                            </div>
                        </div>
                        </div>

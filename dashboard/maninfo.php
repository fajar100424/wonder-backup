...
<head>
    ...
    <title>Manajemen Informasi | SISPPI</title>
              ...
              <div class="dropdown-shortcuts-list scrollable-container">
                ...
                <div class="row row-bordered overflow-visible g-0">
                  <div class="dropdown-shortcuts-item col">
                    ...
                    <small class="text-muted mb-0">Admin Dashboard</small>
                  </div>
                  <div class="dropdown-shortcuts-item col">
                    <span class="dropdown-shortcuts-icon bg-label-secondary rounded-circle mb-2">
              ...
              <div class="card-body">
                <form action="func/addinfo.php" id="formAccountSettings" method="POST" enctype="multipart/form-data">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="assets/img/infaq.jpg" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
    ...
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body">
        ...
        <div class="text-center mb-4">
          <h3>Tambah Kegiatan Akademik</h3>
          <p>Tambah Kegiatan Baru di Kalendar Akademik</p>
        </div>

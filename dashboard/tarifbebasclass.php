        ...
        <div class="navbar-nav align-items-center">
          <div class="nav-item navbar-search-wrapper mb-0">
            <a class="nav-item nav-link px-0">
              ...
              <span>
                <b>Setting Tarif Pembayaran Per Kelas</b> 
              </span>
                    ...
                    <div class="card-body">
                        <div class="col-xl-12">
                            <div class="nav-align-top mb-4">
                                    ...
                                    <li class="nav-item">
                                        <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-justified-home" aria-controls="navs-pills-justified-home" aria-selected="true"><i class="tf-icons bx bx-home"></i> Pilih Kelas </button>
                                    </li>
                                    </ul>
                                    <form action="func/addtarifbebaskelas.php" method="POST">
                                    <div class="row">
                    ...
                    <div class="card-body">
                        <div class="col-xl-12">
                            <div class="nav-align-top mb-4">
                                    ...
                                    <div class="row">
                                        <div class="mb-2 col-lg-12">
                                                <label for="billsama" class="form-label">Tarif (Rp.):</label>
                                                <input type="text" name="billsama" class="form-control" placeholder="Masukkan Nominal">
                                        </div>

...
if (!isset($_SESSION["login"])) {
  echo "<script>swal('Anda Belum Login!', 'Silakan Login Terlebih Dahulu!', 'error').then(function(){
    setTimeout(document.location.href = 'logout.php', 100);
    });</script>";
  exit();
}
...
<head>
    ...
    <!-- Tambahkan link ke ApexCharts CSS -->
    ...
    <!-- Page CSS -->
    <link rel="stylesheet" href="assets/vendor/css/pages/dashboards-crm.css" />
...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <div class="app-brand demo ">
    ...
    <span style="color:var(--bs-primary);">
      <img src="../asset/1.png" alt="Logo Wonder" width="50">
    </span>
    </span>
      ...
      <ul class="menu-inner py-1">
        ...
        <li class="menu-item <?php $_SESSION['active'] == 2 ? print("active open") : print("") ?>">
        <a href="index.php?page=2" class="menu-link">
          <i class="menu-icon tf-icons ri-group-line"></i>
          <div data-i18n="Users">Users</div>
        </a>
        </li>
        <li class="menu-item <?php $_SESSION['active'] == 3 ? print("active open") : print("") ?>">
          <a href="index.php?page=3" class="menu-link">
            <i class='menu-icon tf-icons ri-oil-line'></i>
            <div data-i18n="Manajemen Sumur">Manajemen Sumur</div>
          </a>
        </li>
        <li class="menu-item <?php $_SESSION['active'] == 4 || $_SESSION['active'] == 5 ? print("active open") : print("") ?>">
          <a href="javascript:void(0);" class="menu-link menu-toggle">
            <i class="menu-icon tf-icons ri-shield-keyhole-line"></i>
            <div data-i18n="WONDER">WONDER</div>
          </a>
          <ul class="menu-sub">
            <li class="menu-item <?php $_SESSION['active'] == 4 ? print("active") : print("") ?>">
              <a href="index.php?page=4" class="menu-link">
                <div data-i18n="Manajemen Bobot Item">Manajemen Bobot Item</div>
              </a>
            </li>
            <li class="menu-item <?php $_SESSION['active'] == 5 ? print("active") : print("") ?>">
              <a href="index.php?page=5" class="menu-link">
                <div data-i18n="Manajemen Evidence">Manajemen Evidence</div>
              </a>
            </li>
          </ul>
        </li>
        <li class="menu-item <?php $_SESSION['active'] == 6 ? print("active open") : print("") ?>">
          <a href="index.php?page=6" class="menu-link">
            <i class="menu-icon tf-icons ri-information-2-fill"></i>
            <div data-i18n="Manajemen Informasi">Manajemen Informasi</div>
          </a>
        </li>
        <li class="menu-item">
            ...
            <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
              <div class="avatar avatar-online">
                <?php
                  ...
                  <?php } else {?>
                    <img src="assets/img/avatars/<?=$row['foto'];?>" alt class="w-px-40 h-auto" style="border-radius: 15%;" >
                  <?php }?>
              </div>
            </a>
                ...
                <a class="dropdown-item pb-3" href="pages-account-settings-account.html">
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0 me-3">
                      ...
                      <?php
                        if ($row['foto'] == NULL) {?>
                        <img src="assets/img/avatars/1.png" alt class="w-px-40 h-auto" width="100%">
                        <?php } else {?>
                          <img src="assets/img/avatars/<?=$row['foto'];?>" alt class="w-px-40 h-auto" width="100%">
                        <?php }?>
                      </div>
                    </div>
                    <div class="flex-grow-1">

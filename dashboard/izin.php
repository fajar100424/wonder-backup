...
<head>
    ...
    <title>Izin Santri | SISPPI</title>
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <div class="col-md-12">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class='bx bx-wrench'></i> Izin Keluar & Pulang</a></li>
                            </ul>
                    </div>
                </div>    
            <div class="card-body">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                            <li class="nav-item">
                            <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-justified-home" aria-controls="navs-pills-justified-home" aria-selected="true"><i class="tf-icons bx bx-book"></i>Tambah Izin</button>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content">
                            ...
                            <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                            <li class="nav-item">
                            <button type="button" class="nav-link active" role="tab"><i class="tf-icons bx bx-book"></i>Tambah Izin Keluar Ananda <?=$santri['fullname'];?></button>
                            </li>
                            </ul>
                            <form action="func/addizinkeluar.php" method="POST">
                                        <div class="row">
                                            ...
                                            <label class="form-label" for="basic-icon-default-phone">Dari Pukul <span class="text-danger">*</span></label>
                                            <div class="input-group input-group-merge">
                                                <span id="basic-icon-default-phone2" class="input-group-text"><i class="bx bx-calendar"></i></span>
                                                <input type="time" name="jam_start" class="form-control" placeholder="Contoh 12.00"/>
                                            </div>
                                            </div>
                                            <div class="mb-2 col-md-6">
                                            <label class="form-label" for="basic-icon-default-phone">Sampai Pukul <span class="text-danger">*</span></label>
                                            <div class="input-group input-group-merge">
                                                <span id="basic-icon-default-phone2" class="input-group-text"><i class="bx bx-calendar"></i></span>
                                                <input type="time" name="jam_end" class="form-control" placeholder="Contoh 12.00"/>
                                            </div>
                                            </div>
                                            <div class="mb-2 col-md-12">
                                            <label class="form-label" for="basic-icon-default-phone">Keterangan <span class="text-danger">*</span></label>
                                            <div class="input-group input-group-merge">
                                            ...
                                            <span><small><span class="text-danger">*</span>) Hati-hati dalam mengonfirmasi izin keluar santri.</small></span>
                            ...
                            <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                            <li class="nav-item">
                            <button type="button" class="nav-link active" role="tab"><i class="tf-icons bx bx-book"></i>Tambah Izin Pulang Ananda <?=$santri['fullname'];?></button>
                            </li>
                            </ul>
                            <form action="func/addizinpulang.php" method="POST">
                                        <div class="row">
                                            <input type="hidden" name="id_santri" value="<?=$idsan;?>">
                                            <div class="mb-2 col-md-6">
                                            <label class="form-label" for="basic-icon-default-phone">Tanggal <span class="text-danger">*</span></label>
                                            <div class="input-group input-group-merge">
                                                <span id="tgl" class="input-group-text"><i class="bx bx-calendar"></i></span>
                                                <input type="date" name="tgl" class="form-control "/>
                                            </div>
                                            </div>
                                            <div class="mb-2 col-md-6">
                                            <label class="form-label" for="basic-icon-default-phone">Jumlah Hari <span class="text-danger">*</span></label>
                                            <div class="input-group input-group-merge">
                                                <span id="jumhari" class="input-group-text"><i class="bx bx-calendar"></i></span>
                            ...
                            <div class="tab-pane fade" id="navs-pills-justified-izin-pulang" role="tabpanel">
                                ...
                                <tbody>
                                    ...
                                    <div class="d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="func/hapusizinpulang.php?id=<?=$izp['id_izin_pulang'];?>&idsan=<?=$idsan;?>" onclick="return confirm('Apakah Anda Yakin Menghapus Izin Pulang Ini?')" class="dropdown-item text-danger delete-record">Hapus</a>
                                        </div>
                                    </div>
                                    </td>
                                    </tr>
                            ...
                            <div class="tab-pane fade" id="navs-pills-justified-izin-keluar" role="tabpanel">
                                ...
                                <tbody>
                                    ...
                                    <div class="d-inline-block">
                                        <button class="btn btn-sm btn-primary dropdown-toggle hide-arrow" data-bs-toggle="dropdown">Pilih <i class="bx bx-dots-vertical-rounded"></i></button>
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="func/hapusizinkeluar.php?id=<?=$izk['id_izin_keluar'];?>&idsan=<?=$idsan;?>" onclick="return confirm('Apakah Anda Yakin Menghapus Izin Keluar Ini?')" class="dropdown-item text-danger delete-record">Hapus</a>
                                        </div>
                                    </div>
                                    </td>
                                    </tr>

...
<head>
    ...
    <title>Suluk Santri | SISPPI</title>
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <div class="col-md-12">
                            ...
                            <li class="nav-item"><a class="nav-link" href="profsan.php?idsan=<?=$idsan;?>"><i class='bx bx-user'></i>Catatan Santri</a></li>
                            <li class="nav-item"><a class="nav-link" href="tahfidz.php?idsan=<?=$idsan;?>"><i class='bx bx-book'></i> Tahfidz</a></li>
                            <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class='bx bx-pencil'></i> Suluk</a></li>
                            <li class="nav-item"><a class="nav-link" href="kunjungan.php?idsan=<?=$idsan;?>"><i class='bx bx-car'></i> Kunjungan</a></li>
                            <li class="nav-item"><a class="nav-link" href="kesehatan.php?idsan=<?=$idsan;?>"><i class='bx bx-plus-medical'></i> Kesehatan</a></li>
                            <li class="nav-item"><a class="nav-link" href="izin.php?idsan=<?=$idsan;?>"><i class='bx bx-wrench'></i> Izin Keluar & Pulang</a></li>
                            </ul>
                    </div>
                </div>    
            <div class="card-body">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                                    ...
                                    <tr>
                                      ...
                                      <div class="d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                          <a href="func/hapussuluk.php?id_suluk=<?=$slk['id_suluk'];?>&idsan=<?=$idsan;?>" onclick="return confirm('Apakah Anda Yakin Menghapus Suluk Ini?')" class="dropdown-item text-danger delete-record">Hapus</a>
                                        </div>
                                      </div>
                                      </td>
                                    </tr>
                            ...
                            <hr>
                            <h5 class="text-center">Tambah Suluk Ananda <?=$santri['fullname'];?></h5>
                            <hr>
                            <form action="func/addsuluk.php" id="formAccountSettings" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <select name="tahun" id="tahun" class="form-control select2">
                                                    ...
                                                    <?php
                                                    $tahunajar = query("SELECT * FROM thn_ajaran");
                                                    foreach ($tahunajar as $thnajr) :?>
                                                        <option value="<?=$thnajr['id_thn'];?>"><?=$thnajr['thn_ajaran_start'].'/'.$thnajr['thn_ajaran_end'];?></option>
                                                    <?php endforeach?>
                                                </select>
                                            </div>
                                            </div>
                                            ...
                                            <label class="form-label" for="basic-icon-default-message">Semester <span class="text-danger">*</span></label>
                                            <div class="input-group input-group-merge">
                                            ...
                                            <label class="form-label" for="adab">Adab <span class="text-danger">*</span></label>
                                            <div class="input-group input-group-merge">
                                                <span id="adab" class="input-group-text"><i class="bx bx-note"></i></span>
                                                <input type="number" name="adab" id="adab" class="form-control">
                                            </div>
                                            </div>
                                            <div class="mb-2 col-md-3">
                                            <label class="form-label" for="disiplin">Disiplin <span class="text-danger">*</span></label>
                                            <div class="input-group input-group-merge">
                                                <span id="disiplin" class="input-group-text"><i class="bx bx-note"></i></span>
                                                <input type="number" name="disiplin" id="disiplin" class="form-control">
                                            </div>
                                            </div>
                                            <div class="mb-2 col-md-3">
                                            <label class="form-label" for="inisiatif">Inisiatif <span class="text-danger">*</span></label>
                                            <div class="input-group input-group-merge">
                                                <span id="inisiatif" class="input-group-text"><i class="bx bx-note"></i></span>
                                                <input type="number" name="inisiatif" id="inisiatif" class="form-control">
                                            </div>
                                            </div>
                                            <div class="mb-2 col-md-3">
                                            <label class="form-label" for="kreatif">Kreatif <span class="text-danger">*</span></label>
                                            <div class="input-group input-group-merge">
                                                <span id="kreatif" class="input-group-text"><i class="bx bx-note"></i></span>
                                                <input type="number" name="kreatif" id="kreatif" class="form-control">
                                            </div>
                                            </div>
                                            <div class="mb-2 col-md-3">
                                            <label class="form-label" for="kebersihan">Kebersihan <span class="text-danger">*</span></label>
                                            <div class="input-group input-group-merge">
                                                <span id="kebersihan" class="input-group-text"><i class="bx bx-note"></i></span>
                                                <input type="number" name="kebersihan" id="kebersihan" class="form-control">
                                            </div>
                                            </div>
                                            <div class="mb-2 col-md-3">
                                            <label class="form-label" for="komunikasi">Komunikasi <span class="text-danger">*</span></label>
                                            <div class="input-group input-group-merge">
                                                <span id="komunikasi" class="input-group-text"><i class="bx bx-note"></i></span>
                                                <input type="number" name="komunikasi" id="komunikasi" class="form-control">
                                            </div>
                                            </div>
                                            <div class="mb-2 col-md-3">
                                            <label class="form-label" for="kerapian">Kerapian <span class="text-danger">*</span></label>
                                            <div class="input-group input-group-merge">
                                                <span id="kerapian" class="input-group-text"><i class="bx bx-note"></i></span>
                                                <input type="number" name="kerapian" id="kerapian" class="form-control">
                                            </div>
                                            </div>
                                            
                                            
                                            
                                            <span><small><span class="text-danger">*</span>) Hati-hati dalam mengonfirmasi suluk santri.</small></span>
                                            
                                        </div>
                                        <div class="mt-2">
                                            <button type="submit" class="btn btn-primary me-2">Tambah Suluk &raquo;<i class="bx bx-send"></i></button>

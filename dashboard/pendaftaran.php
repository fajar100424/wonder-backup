        ...
        <div class="navbar-nav align-items-center">
          <div class="nav-item navbar-search-wrapper mb-0">
            <a class="nav-item nav-link px-0">
              ...
              <span>
                <b>Konfirmasi Pendaftaran Santri Baru</b> 
              </span>
                      ...
                      <tr>
                        ...
                        <td>
                            <div class="d-inline-block">
                                ...
                                <a href="konfirmasi_regis.php?idregis=<?=$pendaftar['id_daftar'];?>&ida=<?=$pendaftar['id_akun'];?>&idd=<?=$pendaftar['Id'];?>" class="text-white">Konfirmasi</a>
                                </button>
                                <button class="btn btn-sm btn-primary"><a href="https://wa.me/<?=hportu($pendaftar['notelp']);?>?text=Assalamu'alaikum%20...%0ASaya%20salah%20satu%20dari%20admin%20pondok%20pesantren%20ingin%20menginformasikan%20proses%20selanjutnya%20dari%20Sistem%20pendaftaran%20...%20%F0%9F%99%8F" target="_blank" class="text-white"><i class='bx bxl-whatsapp'></i></a></button>
                            </div>
                        </td>
                      </tr>
                      <?php $i++; endforeach; ?>

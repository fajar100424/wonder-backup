...
<!-- / Navbar -->
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card mb-4">
                    ...
                    <h5>Penilaian Tahun Ajaran : <?=$tahun['thn_ajaran_start'].'/'.$tahun['thn_ajaran_end'];?></h5>
        ...
        <div class="row">
            ...
            <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                  <li class="nav-item">
                    <button type="button" class="nav-link active"><i class="tf-icons bx bx-home"></i> Penilaian Santri</button>
                  </li>
              </ul>
            </div>
            <div class="card-body">

...
$tgl = date('Y-m');
$idpoint = $_GET['id'];
$point = query("SELECT * FROM point WHERE id_point = '$idpoint'")[0];
          ...
          <div class="col-lg-12 col-md-12 col-12 mb-4">
            <div class="card">
              <div class="card-header">
                <h5 class="p">Ubah Point</h5>
                <hr>
              </div>
              <div class="card-body">
                <form action="func/ubahpoint.php" id="formAccountSettings" method="POST" enctype="multipart/form-data">
                        <input class="form-control" type="hidden" name="id" value="<?=$point['id_point'];?>">
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                <label class="form-label" for="keterangan">Catatan Pelanggaran/Penghargaan<span class="text-danger">*</span></label>
                                <div class="input-group input-group-merge">
                                    <input class="form-control" type="text" id="keterangan" name="keterangan" placeholder="" value="<?=ucwords($point['keterangan']);?>" required/>
                                </div>
                                </div>
                                <div class="mb-3 col-md-6">
                                <label class="form-label" for="point">Point<span class="text-danger">*</span></label>
                                <div class="input-group input-group-merge">
                                    <input class="form-control" type="number" id="point" name="point" placeholder="" value="<?=ucwords($point['point']);?>" required/>
                                </div>
                                </div>
                                <span><small><span class="text-danger">*</span>) Hati-Hati Dalam Mengubah Point Santri.</small></span>

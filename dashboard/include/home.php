...
<div class="content-wrapper">
        ...
        <!-- Content -->
          ...
          <div class="row g-6">
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <div class="h-100 position-relative">
                      <img src="assets/img/illustrations/illustration-2.png" alt="Ratings" class="position-absolute card-img-position scaleX-n1-rtl bottom-0 w-auto end-0 me-3 me-xl-0 me-xxl-3 pe-2" width="95">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-3 col-sm-3">
              <div class="card">
                <div class="row">
                  ...
                  <div class="col-6">
                    <div class="h-100 position-relative">
                      <img src="assets/img/illustrations/illustration-3.png" alt="Ratings" class="position-absolute card-img-position scaleX-n1-rtl bottom-0 w-auto end-0 me-3 me-xl-0 me-xxl-3 pe-2" width="81">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <!-- <div class="col-xxl-4 col-md-6">
              <div class="card h-100">
                <img class="card-img-top h-px-200" src="assets/img/elements/laptop.png" alt="laptop image cap" style="object-fit: cover;">
                <div class="card-body">

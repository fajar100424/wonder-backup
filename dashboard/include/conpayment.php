...
$id_bebas_payment = $_GET['idpayment'];
$payment = query("SELECT bebas_payment.*, bebas_pay.*, payment.* FROM bebas_payment INNER JOIN bebas_pay ON bebas_payment.id_bebas_pay = bebas_pay.id_bebas_pay INNER JOIN payment ON bebas_pay.payment_id = payment.payment_id WHERE bebas_payment.id_bebas_payment = '$id_bebas_payment'")[0];
        ...
        <div class="col-lg-12 col-md-12 col-12 mb-4">
            <div class="card">
              ...
              <div class="nav-align-top mb-4">
                ...
                <form action="func/conpayment.php" method="POST" enctype="multipart/form-data">
                <input class="form-control" type="hidden" name="id_santri" value="<?=$payment['id_santri'];?>">
                <input type="hidden" name="id_bebas_payment" value="<?=$payment['id_bebas_payment'];?>">
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" class="form-control" disabled name="bayar" value="<?=ucwords($payment['pembayaran']);?>">
                    </div>
                  </div>
                  <div class="mb-3">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" class="form-control" name="dibayar" disabled value="<?=rupiah($payment['bebas_bill']);?>">
                    </div>
                  </div>
                <div class="mb-3">

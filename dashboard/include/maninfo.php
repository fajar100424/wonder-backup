    ...
    <div class="content-wrapper">
        ...
        <div class="col-lg-12 col-md-12 col-12 mb-4">
          ...
          <div class="col-lg-12 col-md-12 col-12 mb-4" id="event">
                <div class="card">
                <div class="card-header">
                <h5 class="p">Manajemen Kegiatan Kalender WONDER</h5>
                ...
                <div class="nav-align-top mb-4">
                    <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                    <li class="nav-item">
                        <button type="button" class="nav-link active"><i class="tf-icons bx bx-home"></i> Daftar Kegiatan WONDER <span class="badge rounded-pill badge-center h-px-20 w-px-20 bg-danger"><?=$countkegiatan[0]['jumkegiatan'];?></span></button>
                    </li>
                    </ul>
                    <div class="tab-content">

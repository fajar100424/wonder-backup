...
<style>
    ...
    <div class="content-wrapper">
        ...
        <div class="col-12">
            <div class="card mb-4">
            <div class="user-profile-header-banner" style="height:250px; background-image: url('assets/img/backgrounds/bgfix.png'); background-repeat: no-repeat; background-size: cover; background-position: center;">
                
            </div>
            <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                <img src="assets/img/illustrations/rocket.png" alt="user image" class="d-block ms-0 ms-sm-4 rounded user-profile-img">
                </div>
        ...
        <div class="row">
            ...
            <div class="card mb-4">
                ...
                <!-- <div class="col-sm-5 text-center text-sm-left">
                    ...
                    <img src="assets/img/illustrations/rocket.png" height="140" alt="View Badge User" data-app-light-img="illustrations/rocket.png" data-app-dark-img="illustrations/rocket.png">
                    </div>
                </div> -->
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <?php $i=1; foreach ($relatedEvidence as $evidence) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                <?php if (!is_null($latestDocument) && !empty($latestDocument)): ?>
                                    <?php
                                    if (empty($wonder['updated_by'])) {
                                        echo "Belum Diperbarui";
                                    } else {
                                        if (is_null($latestDocument['remarks']) || !isset($latestDocument['remarks'])) {

                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="button-wrapper mb-2">
                                            <a href="assets/wonder/<?=$relatedEvidence['document'];?>" target="_blank" class="btn btn-primary">
                            ...
                            <div class="col-sm-6 mb-2">
                                <label class="form-label" for="progress">Nilai Scores <span class="text-danger">*)</span></label>
                                ...
                                <div class="timeline-event card p-0" data-aos="fade-right">
                                    ...
                                    <div class="card-body">
                                                ...
                                                <div class="mb-sm-0 mb-4 me-12">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-xs me-2">
                                                            <img src="assets/img/avatars/1.png" alt="Reviewer" class="rounded-circle" style="width: 100%; height: auto;">
                                                        </div>
                                        ...
                                        <div class="collapse" id="collapseExample<?= $historyEvidence['id_history']; ?>">
                                            <a href="assets/wonder/<?= $historyEvidence['document']; ?>" target="_blank"><?= $historyEvidence['document']; ?></a>
                                        </div>
                                    </div>
